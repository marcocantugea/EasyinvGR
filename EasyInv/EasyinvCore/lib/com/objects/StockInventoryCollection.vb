...
Namespace com.objects
    Public Class StockInventoryCollection
        Implements IEnumerable, IEnumerator, ICollection

        Private position As Integer = -1
        Private _Items As New List(Of stockinventory)

        Public ReadOnly Property Items() As List(Of stockinventory)
            Get
                Return _Items
            End Get
        End Property
        ...
        Public Sub Add(ByVal Item As stockinventory)
