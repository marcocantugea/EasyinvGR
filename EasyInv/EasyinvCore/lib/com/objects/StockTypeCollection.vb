Namespace com.objects
    Public Class StockTypeCollection
        Implements IEnumerable, IEnumerator, ICollection

        Private position As Integer = -1
        Private _Items As New List(Of stocktype)

        Public ReadOnly Property Items() As List(Of stocktype)
            Get
                Return _Items
            End Get
        End Property
        ...
        Public Sub Add(ByVal Item As stocktype)
